...
VALUES ('DDP_BSC_Tier1_New_Fill_Insert_DS30', $$Delete from reporting.rpt_bsc_claim_history;
...
VALUES(13, '00433677993333910217343001970-01-01', 'bsc910217343001970-01-01', 'Tier 1 with alt Fullfillment', NULL, 'E00010022000CMCM0002', date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', '000012285355', '1578544474', '01', '00093914701', 'Venlafaxine 25mg Tablet', 'N', 'Y', 15382, 'estrogens, excluding hormonal contraceptives', 30.0, 30, '01', '58180090100320', 5.0, 52.22, date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', '1', 1, 'M');
$$);
