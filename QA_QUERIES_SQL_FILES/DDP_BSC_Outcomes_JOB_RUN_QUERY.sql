...
VALUES ('DDP_BSC_Outcomes_JOB_RUN_QUERY', $$begin;
...
select
	...
	,null as "AnnualPatientSavings"
	--ef.alt_annual_patient_savings as "AnnualPatientSavings"
	,null as "AnnualTotalSavings"
	--ef.alt_annual_total_savings as "AnnualTotalSavings"
...
INSERT INTO public.rpt_bsc_ddp_claim_gpi_outcome_prep_data
	(
		...
		, line_of_business, fill_type, mml_record_id, "PA_avoided"
	)
	select distinct 
	t."ReportDate"
