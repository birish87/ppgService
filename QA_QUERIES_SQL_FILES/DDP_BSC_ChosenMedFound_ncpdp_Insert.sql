...
VALUES ('DDP_BSC_ChosenMedFound_ncpdp_Insert', $$Delete from reporting.rpt_bsc_claim_history;
...
VALUES(12, '00433677993333910217343001970-01-01', 'bsc910217343001970-01-01', 'ChosenMed with alt Fullfillment', NULL, 'E00010022000CMCM0002', date_trunc('month', current_date - interval '1' month) + interval '15 DAY', date_trunc('month', current_date - interval '1' month) + interval '15 DAY', '000012285355', '1002295', '07', '70436001206', 'Desvenlafaxine 50mg ER Tablet', 'N', 'Y', 15382, 'estrogens, excluding hormonal contraceptives', 30.0, 90, '01', '58180020207520', 5.0, 52.22, date_trunc('month', current_date - interval '1' month) + interval '15 DAY', '1', 1, 'M');
$$);
