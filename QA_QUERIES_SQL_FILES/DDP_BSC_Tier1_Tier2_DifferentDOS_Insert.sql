...
VALUES ('DDP_BSC_Tier1_Tier2_DifferentDOS_Insert', $$Delete from reporting.rpt_bsc_claim_history;
...
VALUES(13, '00433677993333910217343001970-01-01', 'bsc910217343001970-01-01', 'Tier 2 with alt Fullfillment', NULL, 'E00010022000CMCM0002', date_trunc('month', current_date - interval '1' month)+ interval '1 DAY', date_trunc('month', current_date - interval '1' month)+ interval '1 DAY', '000012285355', '1578544474', '01', '63304019230', 'Desvenlafaxine 100mg ER Tablet', 'Y', 'N', 20804, 'estrogens, excluding hormonal contraceptives', 30.0, 90, '01', '58180020007540', 5.0, 52.22, date_trunc('month', current_date - interval '1' month)+ interval '1 DAY', '1', 1, 'M');
