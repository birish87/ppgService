...
VALUES ('DDP_BSC_Tier2_New_Fill_Insert_Acute_Adjusted_MaxSavings_DaysSupply15', $$--select * from beacon_transactions bt where bt.id =200758;
		
--select * from priced_medications pm where pm.beacon_transaction_id =200758;
--update product_lookup set maintenance =false , periodic =false where ndc ='70436001206';		
...
VALUES(14, '00433677993333910217343001970-01-01', 'bsc910217343001970-01-01', 'Tier 2 with alt Fullfillment', NULL, 'E00010022000CMCM0002', date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', '000012285355', '1578544474', '01', '63304019230', 'Desvenlafaxine 100mg ER Tablet', 'Y', 'N', 20804, 'estrogens, excluding hormonal contraceptives', 30.0, 15, '01', '58180020007540', 5.0, 52.22, date_trunc('month', current_date - interval '1' month)+ interval '15 DAY', '1', 1, 'M');
$$);
