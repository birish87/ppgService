...
VALUES ('DSRD_Horizon_JOB_RUN_QUERY', $$-- :payer = horizon
BEGIN;
------------Begin Alter List----------------
...
where rhch.date_of_service between cast((date_trunc('month', current_date)- '1 second'::interval)- '485 day'::interval as date) and cast(date_trunc('month', current_date)- '1 second'::interval as date)
...
insert into rpt_hzn_dsrd_claim_gpi_outcome_prep_data
select t.*
from temp_output t
